...
def get_c2pa_certs() -> Tuple[str, str]:
    if os.getenv("STW_PROD_ENV"):
        public_key_file = "/wrk/C2PATextPublicKey.pem"
        private_key_file = "/wrk/C2PATextPrivateKey.pem"
    else:
...
def c2pa_sign(input_text: str, public_key: str, private_key: str) -> str:
...
def c2pa_verify(
    candidate_text: str, public_key: str, private_key: str
) -> Tuple[bool, Optional[BasicPayload | ManifestPayload]]:
