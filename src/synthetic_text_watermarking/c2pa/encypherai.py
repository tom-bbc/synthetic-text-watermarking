...
class C2PAText:
    ...
    @staticmethod
    def load_keypair(
        public_key_file: Path, private_key_file: Path
        ...
        return public_key, private_key  # type: ignore
    ...
    def verify(
        ...
        bool, Optional[str], Optional[BasicPayload | ManifestPayload | C2PAPayload]
    ]:
        """
